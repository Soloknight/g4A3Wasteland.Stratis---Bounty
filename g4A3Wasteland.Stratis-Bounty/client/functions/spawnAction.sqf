...
spawnActionHandle = (_this select 1) spawn
{
	...
	if (isNil "playerData_resetPos") then
	{
		...
		{
			case 1: { player setVariable ["cmoney", _baseMoney + 0, true]; [MF_ITEMS_CANNED_FOOD, 1] call mf_inventory_add; [MF_ITEMS_WATER, 1] call mf_inventory_add; [MF_ITEMS_REPAIR_KIT, 1] call mf_inventory_add; };
			case 2: { player setVariable ["cmoney", _baseMoney + 0, true]; [MF_ITEMS_CANNED_FOOD, 0] call mf_inventory_add; [MF_ITEMS_WATER, 0] call mf_inventory_add; [MF_ITEMS_REPAIR_KIT, 2] call mf_inventory_add; };
			case 3: { player setVariable ["cmoney", _baseMoney + 0, true]; [MF_ITEMS_CANNED_FOOD, 0] call mf_inventory_add; [MF_ITEMS_WATER, 0] call mf_inventory_add; [MF_ITEMS_REPAIR_KIT, 2] call mf_inventory_add; };
			case 4: { player setVariable ["cmoney", _baseMoney + 0, true]; [MF_ITEMS_CANNED_FOOD, 0] call mf_inventory_add; [MF_ITEMS_WATER, 0] call mf_inventory_add; [MF_ITEMS_REPAIR_KIT, 2] call mf_inventory_add; };
			case 5: { player setVariable ["cmoney", _baseMoney + 0, true]; [MF_ITEMS_CANNED_FOOD, 0] call mf_inventory_add; [MF_ITEMS_WATER, 0] call mf_inventory_add; [MF_ITEMS_REPAIR_KIT, 2] call mf_inventory_add; };
			case 6: { player setVariable ["cmoney", _baseMoney + 0, true]; [MF_ITEMS_CANNED_FOOD, 0] call mf_inventory_add; [MF_ITEMS_WATER, 0] call mf_inventory_add; [MF_ITEMS_REPAIR_KIT, 2] call mf_inventory_add; };
			case 7: { player setVariable ["cmoney", _baseMoney + 0, true]; [MF_ITEMS_CANNED_FOOD, 0] call mf_inventory_add; [MF_ITEMS_WATER, 0] call mf_inventory_add; [MF_ITEMS_REPAIR_KIT, 2] call mf_inventory_add; };
			case 8: { player setVariable ["cmoney", _baseMoney + 0, true]; [MF_ITEMS_CANNED_FOOD, 0] call mf_inventory_add; [MF_ITEMS_WATER, 0] call mf_inventory_add; [MF_ITEMS_REPAIR_KIT, 2] call mf_inventory_add; };
			case 9: { player setVariable ["cmoney", _baseMoney + 0, true]; [MF_ITEMS_CANNED_FOOD, 0] call mf_inventory_add; [MF_ITEMS_WATER, 0] call mf_inventory_add; [MF_ITEMS_REPAIR_KIT, 2] call mf_inventory_add; };
