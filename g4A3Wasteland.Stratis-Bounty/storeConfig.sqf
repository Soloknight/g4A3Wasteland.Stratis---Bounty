...
[
	[ // Main colors
		...
		[
			...
			["Bloodshot", _texDir + "17_P.paa"],
			["Carbon", _texDir + "19_P.paa"],
			["Confederate", _texDir + "20_P.paa"],
			["Denim", _texDir + "21_P.paa"],
			["Digital", _texDir + "22_P.paa"],
			["Digital Black", _texDir + "23_P.paa"],
			["Digital Desert", _texDir + "24_P.paa"],
			["Digital Woodland", _texDir + "25_P.paa"],
			["Doritos", _texDir + "26_P.paa"],
			["Drylands", _texDir + "27_P.paa"],
			["Hello Kitty", _texDir + "28_P.paa"],
			["Hex", _texDir + "29_P.paa"],
			["Hippie", _texDir + "30_P.paa"],
			//["ISIS", _texDir + "isis.paa"],
			["Leopard", _texDir + "31_P.paa"],
			["Mountain Dew", _texDir + "32_P.paa"],
			["'Murica", _texDir + "murica.paa"],
			//["Nazi", _texDir + "nazi.paa"],
			["Orange Camo", _texDir + "18_P.paa"],
			["Pink Camo", _texDir + "33_P.paa"],
			["Red Camo", _texDir + "34_P.paa"],
			["Pride", _texDir + "35_P.paa"],
			//["Psych", _texDir + "36_P.paa"],
			["Rusty", _texDir + "37_P.paa"],
			["Sand", _texDir + "38_P.paa"],
			["Snake", _texDir + "39_P.paa"],
			["Stripes", _texDir + "40_P.paa"],
			["Stripes 2", _texDir + "41_P.paa"],
			["Stripes 3", _texDir + "42_P.paa"],
			["Swamp", _texDir + "43_P.paa"],
			["Tiger", _texDir + "44_P.paa"],
			["Trippy", _texDir + "45_P.paa"],
			["Union Jack", _texDir + "46_P.paa"],
			["Urban", _texDir + "47_P.paa"],
			["Weed", _texDir + "48_P.paa"],
			["Woodland", _texDir + "49_P.paa"],
			["Woodland Dark", _texDir + "50_P.paa"],
			["Woodland Tiger", _texDir + "51_P.paa"]
		]
	],
	[ // Kart colors
		"Kart_01_Base_F",
