...
private ["_UID", "_bank", "_moneySaving", "_donatorLevel", "_donatorEnabled", "_teamkiller", "_tkCount","_tkAutoSwitchEnabled","_customUniformEnabled", "_uniformNumber", "_result", "_data", "_columns", "_dataTemp", "_ghostingTimer", "_secs"];
_UID = _this;
